...
<head>
    ...
    <title>Explore details no image | TheDir</title>
...
<body>
    <!-- #site-wrapper start -->
    <div id="site-wrapper" class="site-wrapper explore-details explore-details-no-image">
        <!-- #header start -->
        <header id="header"
                class="main-header header-sticky header-sticky-smart header-style-01 bg-white text-uppercase">
        ...
        <div id="wrapper-content" class="wrapper-content pb-0 pt-0">
            ...
            <div class="container">
                <div class="page-container row pt-9">
                    <div class="sidebar col-lg-4 order-1 order-lg-0">
                    ...
                    <div class="page-content col-lg-8 mb-lg-0 order-0 order-lg-1">
                        <div class="explore-details-top bg-white">
                            <div class="media flex-wrap flex-md-nowrap store">
                                <div class="store-image mb-4 mb-md-0 mr-5"><img src="images/other/provider.jpg"
                                                                                alt="Provider"></div>
                            ...
                            <div class="mt-6 d-flex flex-wrap flex-sm-nowrap">
                        ...
                        <div class="explore-details-container">
                            <div class="collapse-tabs">
                                <div class="tabs bg-gray-06 mt-7 px-4 py-2 mb-6 d-none d-sm-block">
                                    <ul class="nav nav-pills tab-style-01" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="reviews-tab" data-toggle="tab" href="#reviews"
                                               role="tab"
                                               aria-controls="reviews" aria-selected="false">Reviews & Rating </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="booking-tab" data-toggle="tab" href="#booking"
                                               role="tab"
                                               aria-controls="booking" aria-selected="false">Booking</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div id="collapse-tabs-accordion">
                                                                ...
                                                                <div class="py-6 media border-top">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <div class="images d-flex flex-wrap">
                                                                            <img src="images/listing/review-01.jpg"
                                                                                 alt="Review 1"
                                                                                 class="mt-4">
                                                                            <img src="images/listing/review-02.jpg"
                                                                                 alt="Review 2"
                                                                                 class="mt-4">
                                                                            <img src="images/listing/review-03.jpg"
                                                                                 alt="Review 3"
                                                                                 class="mt-4">
                                                                        </div>
                                                            ...
                                                            <form>
                                                                <div class="row mb-4 flex-md-nowrap align-items-center">
                                                                        ...
                                                                        <div class="rate-input d-flex">
                                                                            ...
                                                                            <label for="star5" title="text"
                                                                                ...
                                                                                <svg class="icon icon-ionicons_svg_md-star">
                                                                                    <use
                                                                                            xlink:href="#icon-ionicons_svg_md-star"></use>
                                                                                </svg>
                                                                            </label>
                                                                    ...
                                                                    <div class="upload-file col-md-6 text-left text-md-right">
                                                                        <input
                                                                                type="file" id="file"/><label
                                                                            for="file"
                                                                            class="btn btn-white btn-icon-left mb-0 px-6"><i
                                                                            class="fas fa-cloud-upload"></i>Add a
                                                                        Photo</label>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="tab-pane" id="booking" role="tabpanel"
                                            ...
                                            <div class="card bg-transparent mb-4 mb-sm-0">
                                                ...
                                                <div id="booking-collapse" class="collapse collapsible"
                                                        ...
                                                        <div class="widget reservation">
                                                            <div class="form-reservation form-reservation-lg text-center">
                                                                <form>
                                                                    ...
                                                                    <button class="btn btn-primary px-7 font-size-h5"
                                                                            type="submit">
                                                                        Book
                                                                        Now
                                                                    </button>
                            ...
                            <div class="block-more-listing border-top pt-8 mt-7">
                                <div class="d-block text-dark font-weight-semibold font-size-md mb-5 pt-1">Other
                                    Providers Similar to Dr.Matthew Huff DDS
                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <a href="listing-details-no-image.html"
                                                                   class="d-inline-block image mr-3">
                                                                    <img
                                                                            src="images/listing/health-and-medical-provider-1.jpg"
                                                                            alt="Provider 1">
                                                                </a>
                                                                <div class="media-body lh-14">
                                                                    <div class="text-dark">Family Physician</div>
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <a href="listing-details-no-image.html"
                                                                   class="image mr-3">
                                                                    <img
                                                                            src="images/listing/health-and-medical-provider-2.jpg"
                                                                            alt="Provider 2">
                                                                </a>
                                                                <div class="media-body lh-14">
                                                                    <div class="text-dark">Dentist</div>
                                                                    <a class="font-weight-semibold text-link  d-block font-size-md name"
                                                        ...
                                                        <td>
                                                            <div class="media align-items-center">
                                                                <a href="listing-details-no-image.html"
                                                                   class="image mr-3">
                                                                    <img
                                                                            src="images/listing/health-and-medical-provider-3.jpg"
                                                                            alt="Provider 3">
                                                                </a>
                                                                <div class="media-body lh-14">
    ...
    <div id="claim-popup" class="mfp-hide">
        <div class="claim-request-popup text-center card border-0 rounded-0">
            ...
            <div class="card-body py-7 px-8">
                ...
                <h3 class="text-dark font-weight-bold text-uppercase mb-4">all from <span
                        class="text-primary">one</span> dashboard</h3>
                    ...
                    <form>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea id="content" class="form-control"
                                      placeholder="Additional proof to expedite  your claim approval."></textarea>
                        </div>
                        <button type="submit"
                                class="btn btn-primary btn-block text-uppercase font-weight-bold font-size-lg lh-15">
                            claim
                            your business
                            Now
                        </button>
